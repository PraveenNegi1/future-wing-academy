...
export default function WhoWeAre() {
  return (
    <section className="bg-white md:py-20 py-10">
      <div className=" max-w-7xl md:mx-0 mx-8 ">
        <div className="grid items-center justify-center gap-12 md:grid-cols-2">
          ...
          <div>
            ...
            <p className="md:mb-8 text-gray-600 leading-relaxed text-center md:text-left max-w-[340px] md:max-w-none mx-auto md:mx-0">
              Future Wings Aviation Academy is a Dehradun-based pilot
              preparation and mentorship institute dedicated to guiding aspiring
              pilots with clarity, discipline, and the right foundation. We
              focus on structured preparation, informed decision-making, and
              personalised mentoring ensuring students are fully ready before
              stepping into professional flight training.
            </p>
